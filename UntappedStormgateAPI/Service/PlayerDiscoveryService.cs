...
namespace UntappedAPI.Service
{
    public class PlayerDiscoveryService
    {
        ...
        public PlayerDiscoveryService(UntappedApiService dataCollectorService, UntappedDbContext untappedDbContext, CountService totalProgressService)
        {
            _untappedApiService = dataCollectorService;
            _playerIdsQueue = new Queue<string>();
            _untappedDbContext = untappedDbContext;
            _countService = totalProgressService;
        }
